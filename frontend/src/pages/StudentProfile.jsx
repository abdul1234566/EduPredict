...
export default function StudentProfile() {
    ...
    if (loading) {
        return (
            <MainLayout>
                <h2 className="sp-loading">Loading...</h2>
            </MainLayout>
        );
    }
        ...
        <MainLayout>
            ...
            <div className="sp-dashboard">
                ...
                <div className="sp-card">
                    ...
                    <Row title="Age" value={profile?.age || "Not set"} />
                    <Row title="Gender" value={profile?.gender || "Not set"} />
                    <Row title="Student ID" value={profile?.id} />
                ...
                {edit && (
                    <div className="sp-modal">
                        ...
                        <div className="sp-modal-box">
                            ...
                            <button onClick={save} className="sp-btn">
                                Save
                            </button>
...
//         <p className="profile-subtitle">Student account details</p>
